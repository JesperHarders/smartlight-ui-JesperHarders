    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="27.492" height="27.492" viewBox="0 0 27.492 27.492">
          <g id="Icon_feather-settings" data-name="Icon feather-settings" transform="translate(1.25 1.25)">
            <path id="Path_1" data-name="Path 1" d="M20.316,16.908A3.408,3.408,0,1,1,16.908,13.5,3.408,3.408,0,0,1,20.316,16.908Z" transform="translate(-4.412 -4.412)" fill="none" stroke="#002d67" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5"/>
